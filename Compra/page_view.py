...
class PageView:
    def __init__(self, page: ft.Page) -> None:
        ...
        self.container_productosEliminados = ft.Container()
        self.matriz_text = []
    ...
    def home_page(self):
        ...
        self.container_productosEliminados.content = self.print_recalled()
        texto = ft.Text("PRODUCTOS ELIMINADOS")
        container = ft.Container(ft.Column([
                    ft.Container(ft.Text("¡COMPRAS!", size=35, weight="bold"), margin=ft.margin.only(bottom=20)),
                    ft.Row([
                        ft.Column([
                            self.input_key,
                            self.msg_key,
                        ...
                        ft.Column([self.total, self.container, texto, self.container_productosEliminados]),
                    ], expand=True),
                ], 
    ...
    def handle_add(self, e):
        ...
        if self.input_price.value == "":
            self.msg_price.value = "no puede estar vacio"
    ...
    def print_recalled(self):
        ...
        if matriz:
            ...
            return ft.Text("No hay productos", size=35, weight="bold")
    
    def handle_delete(self, e):
        self.msg_error.visible = False
        if self.input_delete.value == "":
            self.msg_delete.value = "no puede estar vacio"
            ...
            if deleted_product:
                ...
                self.msg_delete.value = "el producto no existe"
                self.msg_delete.visible = True
